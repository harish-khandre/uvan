export default function TaC() {
  return (
    <div className="flex justify-center items-center h-full">
      ...
      <p>Welcome to uvanTech!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of UvanTech's Website, located at www.uvan.tech.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use uvan if you do not agree to take all
      ...
      <p>
        We employ the use of cookies. By accessing uvan, you agreed to use
        cookies in agreement with the UvanTech's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, UvanTech and/or its licensors own the
        intellectual property rights for all material on uvan. All intellectual
        property rights are reserved. You may access this from uvan for your own
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from uvan</li>
        <li>Sell, rent or sub-license material from uvan</li>
        <li>Reproduce, duplicate or copy material from uvan</li>
        <li>Redistribute content from uvan</li>
      </ul>
      ...
      <p>
        ...
        UvanTech does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of UvanTech,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, UvanTech shall not be liable
      ...
      <p>
        UvanTech reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant UvanTech a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of UvanTech; and (d) the link is
      ...
      <p>
        ...
        e-mail to UvanTech. Please include your name, your organization name,
      ...
      <p>
        No use of UvanTech's logo or other artwork will be allowed for linking
