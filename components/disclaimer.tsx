export default function Disclaimer() {
  return (
    <div className="flex justify-center items-center h-full">
      <h1>Disclaimer for UvanTech</h1>

      <p>
        If you require any more information or have any questions about our
        site's disclaimer, please feel free to contact us by email at
        uvantech1801@gmail.com. Our Disclaimer was generated with the help of
        the{" "}
      ...
      <h2>Disclaimers for uvan</h2>

      <p>
        All the information on this website - uvan.tech - is published in good
        faith and for general information purpose only. uvan does not make any
        ...
        website (uvan), is strictly at your own risk. uvan will not be liable
